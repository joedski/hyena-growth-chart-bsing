...
function growthChart(options) {
	...
	var chartObject = {
		...
		getDrawingBounds: function getDrawingBounds() {
			...
			var margin = _extends({}, chart.margin());
...
exports.monomolecular = monomolecular;
...
function monomolecular(A, A_L, S0, k, d) {
	var B = B0(A, A_L, S0);
...
var HYENA_FEMALE = exports.HYENA_FEMALE = {
	k: 0.135662,
	S0: 0.205253,
	A: 1.0,
	// A: 1.0/1.05,
...
var g = _interopRequireWildcard(_growth);
...
function dataHyena(params) {
	...
	var growthFn = g.monomolecular(params.A, params.A_L, params.S0, params.k, params.d);
...
var chartSize = function chartSize() {
	return {
...
nv.addGraph(function () {
	var chart = growthChart.init(data).getChart();

	nv.utils.windowResize(function () {
		return growthChart.update();
	});
